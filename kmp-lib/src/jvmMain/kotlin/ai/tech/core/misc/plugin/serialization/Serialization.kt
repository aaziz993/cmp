...
import com.itextpdf.styledxmlparser.jsoup.nodes.Document.OutputSettings.Syntax.xml
...
public fun Application.configureSerialization(config: SerializationConfig?) {
