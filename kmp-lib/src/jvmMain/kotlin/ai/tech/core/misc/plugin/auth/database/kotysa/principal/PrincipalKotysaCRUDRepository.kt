...
public class PrincipalKotysaCRUDRepository(client: R2dbcSqlClient, table: Table<PrincipalEntity>, timeZone: TimeZone = TimeZone.UTC) : AbstractKotysaCRUDRepository<PrincipalEntity>(
