...
internal interface AgentClient {
    ...
    @GET("agent/checks")
    fun getChecks(@QueryMap optionsParameters: Map<String, Any>): Call<Map<String, HealthCheck>>

    @GET("agent/services")
    fun getServices(@QueryMap query: Map<String, Any>): Call<Map<String, Service>>
    ...
    @GET("agent/members")
    fun getMembers(@QueryMap query: Map<String, Any>): Call<List<Member>>
